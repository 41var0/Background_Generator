...
triangle_from_vertical_lines(draw=draw1, color=color, flip_h=True)
# img1.show(title="reversed")
# input()
img2 = Image.new('RGB', (width, height), (0, 0, 0))
draw2 = ImageDraw.Draw(img2)
triangle_from_vertical_lines(draw=draw2, color=color, flip_v=True)
# img2.show(title="reversed")
# input()
img3 = Image.new('RGB', (width, height), (0, 0, 0))
draw3 = ImageDraw.Draw(img3)
triangle_from_vertical_lines(draw=draw3, color=color, flip_h=True, flip_v=True)
